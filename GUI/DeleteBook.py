...
def delete(): 
    ...
    headingLabel = Label(headingFrame1, text="DELETE BOOK", bg='black', fg='white', font=('Times New Roman',40))
    ...
    SubmitBtn = Button(root,text="SUBMIT",bg='yellow', fg='black',command=deleteBook)
